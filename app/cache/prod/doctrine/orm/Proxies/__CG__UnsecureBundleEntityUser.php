...
namespace Proxies\__CG__\UnsecureBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \UnsecureBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'subjects', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'comments', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'pseudo', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'admin', '' . "\0" . 'UnsecureBundle\\Entity\\User' . "\0" . 'creationDate'];
        }
