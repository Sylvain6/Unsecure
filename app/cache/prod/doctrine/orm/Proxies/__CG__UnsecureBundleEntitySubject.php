 ...
 */
class Subject extends \UnsecureBundle\Entity\Subject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UnsecureBundle\\Entity\\Subject' . "\0" . 'id', '' . "\0" . 'UnsecureBundle\\Entity\\Subject' . "\0" . 'user', '' . "\0" . 'UnsecureBundle\\Entity\\Subject' . "\0" . 'comments', '' . "\0" . 'UnsecureBundle\\Entity\\Subject' . "\0" . 'text', '' . "\0" . 'UnsecureBundle\\Entity\\Subject' . "\0" . 'creationDate', '' . "\0" . 'UnsecureBundle\\Entity\\Subject' . "\0" . 'private'];
        }
