 ...
 */
class Comment extends \UnsecureBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UnsecureBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'UnsecureBundle\\Entity\\Comment' . "\0" . 'user', '' . "\0" . 'UnsecureBundle\\Entity\\Comment' . "\0" . 'subject', '' . "\0" . 'UnsecureBundle\\Entity\\Comment' . "\0" . 'text', '' . "\0" . 'UnsecureBundle\\Entity\\Comment' . "\0" . 'creationDate'];
        }
